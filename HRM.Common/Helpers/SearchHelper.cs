    ...
    public class SearchHelper
    {
            ...
            ref DateTime dateFrom, ref DateTime dateTo, ref int quarterData)
        {
            switch (timeType)
            {
                ...
                case HRMConstants.TimeType_LastWeek:
                    {
                ...
                case HRMConstants.TimeType_ThisQuarter:
                    {
                ...
                case HRMConstants.TimeType_LastQuarter:
                    {
                ...
                case HRMConstants.TimeType_Year:
                    {
                        dateFrom = new DateTime(year, 1, 1).ToStartDate();
